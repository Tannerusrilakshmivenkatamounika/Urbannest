  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center md:text-left">
      ...
      <div className="flex flex-col items-center md:items-start">
        ...
        {/* Social Icons */}
        <div className="flex gap-5 mt-6 justify-center md:justify-start text-gray-700">
    ...
    {/* BOTTOM */}
    <div className="mt-14 pt-6 border-t border-gray-300 text-sm text-gray-500 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
